...
**What it's for:** Web development, data science, automation, AI/machine learning, scripting, backend APIs.
...
- *Local:* Data analysis roles at banks and telecoms, NGO data projects, internal tooling at larger companies. Limited but growing.
...
**What it's for:** Websites, web applications, mobile apps (React Native), backend servers (Node.js), everything that runs in a browser.
...
- Tools like VS Code give you excellent offline development experience

**Job market:**

- *Local:* Web development agencies in Harare and Bulawayo, startup MVPs, e-commerce sites for local businesses. The most locally employable skill.
- *Remote:* Enormous demand. React/Next.js developers earn $3,000–$8,000/month remotely. TypeScript is increasingly required, not optional.
- *Freelance:* Building websites and web apps for local and international clients. The bread and butter of freelancing in Zimbabwe.
...
**What it's for:** Backend services, APIs, cloud infrastructure, DevOps tooling, high-performance systems.
...
- Growing demand as companies move to cloud-native architectures
...
**Verdict:** Not a first language. Learn after Python or JavaScript once you understand [system design fundamentals](/writing/system-design-explained-for-beginners). But if you want to stand out in the remote job market and earn at the higher end, Go is a strong second language.

### Dart / Flutter

**What it's for:** Cross-platform mobile apps (iOS + Android from one codebase), web apps, desktop apps.
...
- *Local:* Growing. Several Zimbabwean startups building mobile apps use Flutter. Agencies increasingly offer Flutter development.
- *Remote:* Moderate demand. Not as large as React Native (JavaScript-based alternative), but growing steadily. $2,500–$5,000/month remotely.
- *Freelance:* Building mobile apps for local businesses. Good opportunity because few Zimbabwean developers specialise in mobile.

**Industries using Dart/Flutter in Zimbabwe:** Fintech, health tech, delivery/logistics startups, any business that needs a mobile presence.

**Verdict:** Learn if you want to build mobile apps specifically. The mobile-first nature of African markets makes this more relevant here than in Western markets.
...
## Practical considerations for Zimbabwe
...
- Python: Official docs downloadable, freeCodeCamp's text curriculum
- JavaScript: MDN Web Docs available offline, The Odin Project
- Go: "A Tour of Go" works offline, official spec is one page
- Dart/Flutter: Flutter docs downloadable, well-organised
...
| Language | Local (ZW, monthly) | Remote (monthly) | Freelance (per project) |
|----------|---------------------|-------------------|------------------------|
| Python | $300–$800 | $2,000–$6,000 | $500–$5,000 |
| JavaScript/TS | $300–$1,000 | $3,000–$8,000 | $300–$10,000 |
| Go | Rare locally | $4,000–$9,000 | Uncommon |
| Dart/Flutter | $300–$700 | $2,500–$5,000 | $1,000–$8,000 |
| Java | $400–$1,200 | $3,000–$7,000 | $500–$5,000 |

These are mid-level ranges (2-4 years experience). Junior developers earn less; senior developers earn more. Remote rates assume you're working for international companies.

## Which should you learn first?

Use this decision framework:

**"I want to get employed as fast as possible (locally)"**
→ JavaScript/TypeScript. More local web development jobs exist than any other category.

**"I want to maximise remote earning potential"**
→ JavaScript/TypeScript first (most opportunities), then add Go or Python for specialisation.

**"I'm interested in AI and data"**
→ Python. It's the only serious choice for AI/ML work.

**"I want to build mobile apps"**
→ Dart/Flutter for cross-platform, or JavaScript with React Native if you want to stay in one ecosystem.

**"I don't know what I want yet"**
→ Python. Lowest barrier, broadest applicability, and you can pivot to web (Django/FastAPI), data, automation, or AI from there.

**"I want to build websites for local businesses and freelance"**
→ JavaScript (React/Next.js) or PHP (Laravel). Both have abundant freelance work.

## The path forward

Whatever language you choose, the trajectory is the same:

1. Learn fundamentals (2-3 months)
2. Build projects (ongoing)
3. Specialise in a niche (month 4-6)
4. Start earning (month 6-12)

I've written a detailed roadmap for this entire journey in my guide on [how to become a software developer in Zimbabwe](/writing/how-to-become-a-software-developer-in-zimbabwe). It covers everything from choosing your first project to landing your first client or job.
...
Pick one. Commit for three months. Build something real. The rest follows.

---

If you're a developer in Zimbabwe looking for guidance on your next career move, or a business looking for development talent locally, [get in touch](/contact). I work with both individuals building their careers and organisations building their teams.
